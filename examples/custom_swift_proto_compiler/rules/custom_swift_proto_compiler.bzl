...
load("@rules_swift//proto:swift_proto_common.bzl", "swift_proto_common")
load("@rules_swift//swift:providers.bzl", "SwiftInfo", "SwiftProtoCompilerInfo")
